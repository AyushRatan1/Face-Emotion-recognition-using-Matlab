% realTimeEmotionDetectionWithGraph.m
function realTimeEmotionDetectionWithGraph()
    ...
    fig.Color = [0.2, 0.2, 0.2];  % Dark background color
    ...
    b.FaceColor = 'flat';
    b.CData = repmat([0.2, 0.8, 0.2], length(emotionLabels), 1);  % Green bars
    ylim(axGraph, [0 10]);
